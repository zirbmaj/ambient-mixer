...
const LAYERS = [
    ...
    },
    {
        ...
        category: 'weather',
        type: 'sample',
        src: '/audio/seamless/heavy-rain.mp3',
        create: (ctx, dest) => {
            const noise = createNoise(ctx);
            const filter = ctx.createBiquadFilter();
            filter.type = 'bandpass';
    ...
    },
    {
        ...
        category: 'weather',
        type: 'sample',
        src: '/audio/seamless/thunder.mp3',
        create: (ctx, dest) => {
            const noise = createNoise(ctx);
            const filter = ctx.createBiquadFilter();
            filter.type = 'lowpass';
    ...
    },
    {
        ...
        category: 'nature',
        type: 'sample',
        src: '/audio/seamless/crickets.mp3',
        create: (ctx, dest) => {
            const gain = ctx.createGain();
            gain.gain.value = 0;
            gain.connect(dest);
